...
<html>
    ...
    <body>
        ...
        <div class="game_navbar" style="margin-top:30px;">
            ...
            <a href="valorant.php"  class="active">Valorant</a>
        </div>
        ...
        <div>
            <div style="display:flex; align-items: center;">
                <h1 style="margin-top: 20px; margin-bottom: 20px; padding-left: 20px;">Valorant</h1>
            </div>
            <img src="img/valorant_banner.jpg" alt="Banner" style="width:100%; height: 550px;"/>
            
            <div class="Latest">
                <h1>Latest News</h1>
                <?php 
                   $api_latest_url = "http://localhost/Web%20Development/public_html/api/objects/readLatestValorant.php";
            ...
            <div class="game_info">
                ...
                <div style="background-image:  url('img/valorant_banner02.jpg'); background-size:cover; background-color: rgba(255,255,255,0.6); background-blend-mode: lighten; padding: 30px;">
                        <ul>
                            <li><strong>Platform:</strong> Windows</li>
                            <li><strong>Release Date:</strong> 2. June 2020</li>
                            <li><strong>Model:</strong> Free2Play + Microtransactions</li>
                            <li><strong>Genre:</strong> First-Person Shooter, Tactical Shooter</li>
                        </ul>
                        <ul>
                            <li><strong>Cross-Platform Support:</strong> No</li>
                            <li><strong>Entwickler:</strong> Riot Games</li>
                            <li><strong>Publisher:</strong> Riot Games</li>
            ...
            <div class="content">
                <h2>All News</h2>
                <?php 
                   $api_latest_url = "http://localhost/Web%20Development/public_html/api/objects/readValorant.php";
                   $json_latest_data = file_get_contents($api_latest_url);
                   $latest_data = json_decode($json_latest_data);
